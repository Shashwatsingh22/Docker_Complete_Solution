...
app.post("/img-ser",(req,res)=>
{
   ...
   var apiUrl = "http://"+mip+":3000/imgSer";
    ...
    apiUrl += '/view';
        ...
        console.log(apiUrl);
          ...
          .then((ress) => {
              ...
              console.log('Body: ', ress.data);

              wdata=ress.data['output'];
...
{
   var subSer= req.body.subSer;
   var apiUrl = "http://"+mip+":3000/contSer";
   ...
   {
     var inPort=req.body.in_Port;
     var outPort=req.body.out_Port;
     var imgName = req.body.image_name_with_ver;
